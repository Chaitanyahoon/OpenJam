...
const EMOJIS = {
  ...
  nature: [
    ...
    { char: ' butterflies', tags: ['butterfly', 'bug', 'insect'] },
    { char: '🐌', tags: ['snail', 'bug'] },
    ...
    { char: '🦑', tags: ['squid', 'sea'] },
    { char: ' lobster', tags: ['lobster', 'sea', 'food'] },
  ...
  food: [
    ...
    { char: 'Tomato', tags: ['tomato', 'vegetable'] },
  ...
  activities: [
    ...
    { char: ' skateboard', tags: ['skateboard', 'skate'] },
    { char: ' ski', tags: ['ski', 'snow'] },
    { char: '🏂', tags: ['snowboard', 'snow'] },
    { char: 'bowling', tags: ['bowling', 'pins'] },
    { char: '⛳', tags: ['golf', 'hole'] },
    { char: '🎯', tags: ['darts', 'target', 'bullseye'] },
    { char: 'chess', tags: ['chess', 'board'] },
  ...
  objects: [
    ...
    { char: 'flashlight', tags: ['flashlight', 'light'] },
